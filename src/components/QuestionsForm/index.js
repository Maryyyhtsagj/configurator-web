  ...
  const inputs = [
    ...
    },
    {
      ...
      items: [
        ...
        { value: 'price', label: t(DICTIONARY.topicOptions.price) },
        { value: 'consultation', label: t(DICTIONARY.topicOptions.consultation) },
        { value: 'order', label: t(DICTIONARY.topicOptions.order) },
        { value: 'repBug', label: t(DICTIONARY.topicOptions.repBug) },
      ],
      value: topic,
